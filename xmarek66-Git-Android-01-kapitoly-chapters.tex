 ...
 Tato sekce čerpá informace z oficiálních návodů pro architekturu \emph{Android}~\footnoteURL{https://developer.android.com/jetpack/docs/guide}. Jedná se o doporučenou architekturu pro vývoj mobilních aplikací a aplikace, které se týká tato práce je na ní postavena. Pro implementaci této architektury se využívá knihovny \emph{Android Jetpack}~\footnoteURL{https://developer.android.com/jetpack}.
    ...
    Existují dva základní architektonické principy. Jejich použití řeší problém kde uchovávat data a stav aplikace tak, aby byly odděleny od uživatelského rozhraní a aplikace byla dobře testovatelná a konzistentní.
        ...
        \begin{enumerate}
            ...
            \item \textbf{ViewModel}~\footnoteURL{https://developer.android.com/reference/androidx/lifecycle/ViewModel} je třída, umožňující ukládat a spravovat data aplikace nezávisle na jejím životním cyklu.
            \item \textbf{LiveData}~\footnoteURL{https://developer.android.com/reference/android/arch/lifecycle/LiveData} je třída obsahující data. Je uzpůsobena ke komunikaci mezi aktivitou / fragmentem a \emph{ViewModelem}.
            \item \textbf{Repository} poskytuje operace nad daty.
            \item \textbf{Model} definuje data databáze.
            \item \textbf{Room}~\footnoteURL{https://developer.android.com/topic/libraries/architecture/room} je knihovna poskytující abstraktní vrstvu nad SQLite databází.
        \end{enumerate}
