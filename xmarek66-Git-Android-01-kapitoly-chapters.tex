...
Pro tuto aplikaci je výhodnější využití dynamicky linkovaných binárních souborů. Lépe se s nimi pracuje a aplikace bude snadno do budoucna rozšiřitelná. Navíc je velké množství dynamicky linkovaných programů již připraveno pro kompilaci využitím \emph{Termux-packages}\footnoteURL{https://github.com/termux/termux-packages/}.

\section{Volba aplikačního binárního rozhraní - ABI}
Sice zařízení Android nemají jednotné ABI\footnoteURL{https://developer.android.com/ndk/guides/abis}, ale naprostá většina jich pracuje na některé z architektur \emph{arm}\footnoteURL{https://androidbycode.wordpress.com/2015/07/07/android-ndk-a-guide-to-deploying-apps-with-native-libraries/}. Architektura \emph{x86} a \emph{x86\_64} je podporována minimálním počtem zařízení. Užívá se zejména pro Android emulátory, které jsou s ní schopné podávat vyšší výkony. Architektura \emph{armeabi-v7a} je 32-bitová, \emph{arm64-v8a} 64-bitová. Sice jsou tyto 64-bitové architektury zpětně kompatibilní s jejich 32-bitovými protějšky, ale od aplikací je od \emph{Googlu} vyžadována jak podpora 32-bitových, tak 64-bitových binárních souborů.

První verze aplikace tedy bude podporovat 32-bitovu \emph{armeabi-v7a} i 64-bitovou \emph{arm64-v8a} architekturu. Takto vytvořený instalační balíček má méně než 100MB, což je ještě pro většinu obchodů aplikací přípustná velikost.
V dalších verzích aplikace se počítá s rozšířením pro ostatní ABI. Tento účel splní více různých cest. Nejjednodušší možností je zabalit do balíčku všechny architektury a nechat aplikaci vybrat tu správnou. Takto vytvořený balíček bude samozřejmě zabírat velké množství místa. Lze také vytvářet tzv. splity\footnoteURL{https://developer.android.com/studio/build/configure-apk-splits}, nebo aplikaci balit do formátu AAB\footnoteURL{https://developer.android.com/guide/app-bundle}.
