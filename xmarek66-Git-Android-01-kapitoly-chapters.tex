...
Mezitím bude probíhat testování v reálném provozu, které odhalí reálný potenciál aplikace. Na základě této zpětné vazby budou přidávány i další příkazy \emph{Gitu} a jiné funkce aplikace. Současně bude také přepracováváno a zdokonalováno uživatelské rozhraní.
