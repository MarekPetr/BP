...
První verze aplikace tedy podporuje 32-bitovu \emph{armeabi-v7a} i 64-bitovou \emph{arm64-v8a} architekturu. Takto vytvořený instalační balíček má méně než 60MB, což je ještě pro většinu obchodů aplikací přípustná velikost.
