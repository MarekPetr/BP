...
Aplikace oproti mnoha jiným aplikací této platformy neobsahuje správce souborů. Integrovaný správce souborů se obecně ukázal jako nedostačující a uživatel je pro plnou správu souborů i v jejich případě nucen užít jiné aplikace.
